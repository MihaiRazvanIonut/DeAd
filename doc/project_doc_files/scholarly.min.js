! function e(t, s, a) {
    ...
    2: [function (e, t, s) {
        ...
        function i(e) {
            for (var t = 2, s = e.parentNode; s;) "section" === s.localName && t++, s = s.parentNode;
            return t
        }

        function n(e, t) {
            for (var s = [], a = e.firstElementChild; a;) a.localName === t && s.push(a), a = a.nextElementSibling;
            return s
        }
    ...
    4: [function (e, t, s) {
        t.exports = {
            ...
            defines: [{
                ...
                unionOf: ["http://purl.org/spar/deo/Materials", "http://purl.org/spar/deo/Methods"],
                ...
                comment: "A set of definitions for abbreviations used in the document.",
                ...
                subClassOf: ["http://purl.org/spar/deo/DiscourseElement", "schema:CreativeWork"],
                disjointWith: ["sa:Unspecified"],
                status: "testing"
            }, {
                "@id": "sa:FormulaObject",
                ...
                subClassOf: ["http://purl.org/spar/deo/DiscourseElement", "schema:MediaObject"],
                status: "testing"
            }, {
                ...
                subClassOf: "schema:Intangible",
                comment: "Defines the permissions granted to an agent to access a resource",
                status: "testing",
                ...
                "@type": "rdf:Property",
                label: "selector",
                comment: "A selector identifying the location of of a web resource where this thing is refered",
                range: "sa:WebVerse",
                ...
                label: "TagAction",
                altLabel: "Tag Action",
                comment: "The act of annotating an object with the motivation of taging it",
                subClassOf: ["sa:AnnotationAction"],
                status: "testing"
            }, {
                ...
                comment: "The act of annotating an object with the motivation of classifying it",
                subClassOf: ["sa:AnnotationAction"],
                status: "testing"
            }, {
                "@id": "sa:Project",
